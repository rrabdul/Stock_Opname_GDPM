<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ Request::segment(1) == 'stock.index' ? 'active' : '' }}">
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'transaction-create' ? 'show' : '' }}" role="list"
          id="submenu-app" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'transaction-create' ? 'active' : '' }}">
              <a class="nav-link" href="/transaction-create">
                <span class="sidebar-text">Transaction In</span>
              </a>
            </li>
          </ul>
        </div>
